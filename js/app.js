...
menuInfo.addEventListener('click', (e) => {
  ...
  if (eTarget.dataset.nav["sub"]) {
    ...
    if (targetId === 'services') {
      ...
      document.querySelector('.services-menu-container').classList.add('show-menu');
    } else if (targetId === 'patient') {
      submenuContainer.forEach((menu) => {
        menu.classList.remove('show-menu');
      })
      document.querySelector('.patient-menu-container').classList.add('show-menu');
